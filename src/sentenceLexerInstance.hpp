...
public:
	...
	virtual std::vector<WeightedSentenceTerm> similarTerms( const std::string& type, const std::vector<WeightedSentenceTerm>& termlist, double dist, int maxNofResults, double minWeight) const;
