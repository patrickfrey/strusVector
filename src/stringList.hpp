...
public:
	...
	void push_back( const std::string& value)
	{
		...
		{
			throw std::runtime_error( _TXT("string list element contains null bytes"));
		}
	...
	{
		if (idx >= m_indexlist.size()) throw std::runtime_error( _TXT("array bound read in string list"));
